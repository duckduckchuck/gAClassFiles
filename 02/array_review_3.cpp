...
int main()
{
   ...
   char smallArray[smallArraySize];
   for (int i = 0; i < smallArraySize; i++) {
      smallArray[i] = '*';
   }

   const int mediumArraySize = 90;
   char mediumArray[mediumArraySize];
   ...
   const int superArraySize = 300;
   char superArray[superArraySize];
   for (int i = 0; i < superArraySize; i++) {
      if (i % 3 == 0){
         superArray[i] = 'P';
      } else {
         superArray[i] = 'E';
